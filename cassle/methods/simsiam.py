...
class SimSiam(BaseModel):
    ...
    def learnable_params(self) -> List[dict]:
        ...
        extra_learnable_params1: List[dict] = [
            {"params": self.projector.parameters()},
            {"params": self.predictor.parameters(), "static_lr": True},
        ]

        extra_learnable_params2: List[dict] = [
            {"params": self.projector.parameters()},
            {"params": self.predictor.parameters()},
        ]

        self.learnable_params_list = super().learnable_params + extra_learnable_params1

        return super().learnable_params + extra_learnable_params2
    ...
    def adjust_learning_rate(self):
        ...
        for param_group, param_list in zip(self.optimizer_temp.param_groups, self.learnable_params_list):
            if 'static_lr' in param_list and param_list['static_lr']:
