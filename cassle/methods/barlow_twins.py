...
class BarlowTwins(BaseModel):
    def __init__(
        self, proj_hidden_dim: int, output_dim: int, lamb: float, scale_loss: float, negative_lamb: float, **kwargs
    ):
        ...
        self.negative_lamb = negative_lamb
    ...
    def add_model_specific_args(parent_parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument("--negative_lamb", type=float, default=1)
