...
#     print ('last_checkpoint_file : ', last_checkpoint_file)
    ...
    for task_idx in range(start_task_idx, num_tasks):
        ...
        if task_idx != 0 and distill_args:
            ...
            if 'mocov2plus_pnr' in task_args["--distiller"] or 'simclr_pnr' in task_args["--distiller"]:
                task_args["--pnr_loss"] = "--pnr_loss"
                print ('set pnr_loss = True')
